...
import { getPlaceHours } from "@/lib/geo/geocoding";
import { CATEGORY_LABEL, type Day, type Destination, type DestinationCategory, type LatLng } from "@/lib/types";
...
export default function DestinationForm({
  ...
  function handlePick(point: LatLng, suggestedName: string, pid: string | null) {
    setPicked(point);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative z-10 flex h-[80vh] w-full max-w-lg flex-col overflow-y-auto rounded-t-2xl border-t-2 border-ink bg-paper p-5 pb-8 shadow-2xl">
